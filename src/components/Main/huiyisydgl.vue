<template>
    <div class="huiyisydgl">
        <div class="gl_box">
            <div class="gl_box_title">
                <span style="font-size: 14px;">查询并选择会议室</span>
            </div>
            <!-- 区域表头 -->
            ...
            <div class="gl_box_title">
                <span style="font-size: 14px;">会议室 预订一览。选择日历时间段可直接预定</span>
            </div>
            <!-- 时间表头 -->
            <div class="sj_toolbar">
                <div class="sj_left">
                    <el-button-group>
                        <el-button type="primary" size="mini" icon="el-icon-caret-left" @click="myClick_1($event)"></el-button>
                        <el-button type="primary" size="mini" icon="el-icon-caret-right" @click="myClick_2($event)"></el-button>
                    </el-button-group>
                    <el-row>
                ...
                <div class="sj_right">
                    <el-button-group>
                        <el-button type="primary" size="mini" @click="myClick_3($event)">月</el-button>
                        <el-button type="primary" size="mini" @click="myClick_4($event)">周</el-button>
                        <el-button type="primary" size="mini" @click="myClick_5($event)">日</el-button>
                    </el-button-group>
                </div>
            </div>
            <div>
                <template>
                    <el-table :data="tableData2" height="510" border style="width: 100%" size='mini'>
                        <el-table-column prop="date" label="" width="50">
                        </el-table-column>
                        <el-table-column prop="date_1" label="周六9月8日" width="215">
                        </el-table-column>
                        <el-table-column prop="date_2" label="周日9月9日" width="215">
                        </el-table-column>
                        <el-table-column prop="date_3" label="周一9月10日" width="210">
                        </el-table-column>
                        <el-table-column prop="date_4" label="周二9月11日" width="240">
                        </el-table-column>
                        <el-table-column prop="date_5" label="周六9月12日" width="240">
                        </el-table-column>
